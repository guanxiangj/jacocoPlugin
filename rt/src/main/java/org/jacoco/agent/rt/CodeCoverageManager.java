...
public class CodeCoverageManager {
    ...
    private static String URL_HOST = "http://192.168.16.150:8080";//内网 服务器地址
    ...
    public static void init(Context context,String serverHost){
        Log.d("debug init","init1111111111");
        ...
        if (!dir.exists()){
            ...
            if(dirs){
                Log.d("init jococo创建文件夹成功","dirPath:"+dirPath);
            }else{
                Log.d("init jacoco","创建文件夹失败dirPath:"+dirPath);
            }
    ...
    private void writeToFile() {
        Log.d("debug write to file","write");
